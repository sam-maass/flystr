export function getDealMetaData({
  ...
  const twitterDescription = `Pay less, travel more - with flights from ${subtitle} starting at just ${minPrice} ${currency}. Plan your own bargain trips for free on Tripfixed and start saving.`; // 67 chars on FB, >200 on twitter
